...
public class TakePhoto : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		if(tex != null)
		{
			...
			GUI.DrawTexture(new Rect(Screen.width / 2 - 150, Screen.height / 2 - 190, 580, 600), tex);
		}
	}
	...
	public IEnumerator start()
	{
		...
		if(Application.HasUserAuthorization(UserAuthorization.WebCam))
		{
			...
			tex = new WebCamTexture(deviceName, 600, 600, 12);
			tex.Play();
		}
	}
	/// <summary>  
	...
	public IEnumerator getTexture()
	{
		...
		t.ReadPixels(new Rect(Screen.width / 2 - 200, Screen.height / 2 - 50, 600, 600), 0, 0, false);
		//距X左的距离        距Y屏上的距离  
	...
	public IEnumerator SeriousPhotoes()
	{
		...
		{
			yield return new WaitForEndOfFrame();
			Texture2D t = new Texture2D(600, 600, TextureFormat.RGB24, true);
			t.ReadPixels(new Rect(Screen.width / 2 - 180, Screen.height / 2 - 50, 600, 600), 0, 0, false);
			t.Apply();
			print(t);
			byte[] byt = t.EncodeToPNG();
